...
- Main documentation set in /docs/documentation – reflect changes, removals, and additions, and add clear, minimal explanations and examples.
...
3. NEVER create new documentation files in the same directory as overview, feature, cr or plan documents - these directories are for historical reference only, not for new documentation.
4. Avoid redundancy unless it improves usability.
5. To avoid repetition, always review the existing file(s) being updated before deciding if more documentation needs to be written.
